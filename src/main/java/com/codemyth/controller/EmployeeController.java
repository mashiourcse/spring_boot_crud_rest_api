...
public class EmployeeController {
	...
	public String createNewEmployee(@Validated @RequestBody Employee employee) {
		
		employeeRepository.save(employee);
		return "Employee Created in database" + employee.toString();
	}
...
//	public ResponseEntity<Employee> getEmployeeByempcity(@RequestParam("city") String city) {
//		Employee emp = employeeRepository.findByCity(city);
